...
def find_max_number_apples_that_we_can_collect(Apples,n,m):
...
print "Maximum Number of Apples that can be collected: "+str(find_max_number_apples_that_we_can_collect(Apples,4,2))
